...
public class DisjointSets {
  ...
  /**
   *  union() unites two disjoint sets into a single set.  A union-by-rank
   *  heuristic is used to choose the new root.  Works
   *  for any two nodes.
   *
   *  @param node1 a node of the first set.
   *  @param root2 a node of the second set.
   **/
  
  public void union2(int node1, int node2) {
